...
{
	// For suppressing warnings about unused private files
	(void)m_numPerturbationIterations;
	(void)m_minimumPointsPerturbationThreshold;

	// Suppressing warnings about unused parms
	(void)body0Wrap;
	(void)body1Wrap;
}
