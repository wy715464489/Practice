...
// the interface
IMPLEMENT_SYSTEM_COMPONENT(VuKeyboard, VuXb1Keyboard);


//*****************************************************************************
VuXb1Keyboard::VuXb1Keyboard()
{
	memset(mKeyMap, 0, sizeof(mKeyMap));
}

//*****************************************************************************
bool VuXb1Keyboard::init()
{
	if ( !VuKeyboard::init() )
		return false;
...
//*****************************************************************************
void VuXb1Keyboard::onKeyDown(VUUINT virtualKey)
{
...
//*****************************************************************************
void VuXb1Keyboard::onKeyUp(VUUINT virtualKey)
{
	VUUINT32 key = mKeyMap[virtualKey];
	if ( key )
	{
