...
#define VUPLATFORM "Android"


// standard types

typedef int         VUINT;
typedef signed char VUINT8;
...
// assertion
	...
	{																			\
		...
		{																		\
			...
			__android_log_assert(#exp, "VectorEngine",  #msg);					\
		}																		\
	}
#endif
...
#define VU_COMPILE_TIME_ASSERT(cond) static_assert(cond, #cond)
